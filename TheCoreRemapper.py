...
CONFLICT_CHECKS = [['AnionPulseCrystals/FleetBeacon', 'ResearchInterceptorLaunchSpeedUpgrade/FleetBeacon', 'Cancel'], #LotV Multiplayer/Protoss/Structures/Fleet Beacon
                   ...
                   ['SelectBuilder', 'Lower/SupplyDepot', 'Halt', 'Cancel'], #LotV Multiplayer/Terran/Structures/Supply Depot/General
                   ['Raise/SupplyDepotLowered'], #LotV Multiplayer/Terran/Structures/Supply Depot/Lowered
                   ...
                   ['Explode/HotSHunterBurrowed', 'BurrowUp'], #HotS Campaign/Zerg/Units/Baneling (Hunter Strain)/Burrowed
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Explode/HotSHunter', 'DisableBuildingAttack/HotSHunter', 'BurrowDown'], #HotS Campaign/Zerg/Units/Baneling (Hunter Strain)/Enabled Building Attack
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Explode/HotSHunter', 'EnableBuildingAttack/HotSHunter', 'BurrowDown'], #HotS Campaign/Zerg/Units/Baneling (Hunter Strain)/General
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Explode/HotSSplitterlingBig', 'DisableBuildingAttack/HotSSplitterlingBig', 'BurrowDown'], #HotS Campaign/Zerg/Units/Baneling (Splitter Strain)/Enabled Building Attack
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Explode/HotSSplitterlingBig', 'EnableBuildingAttack/HotSSplitterlingBig', 'BurrowDown'], #HotS Campaign/Zerg/Units/Baneling (Splitter Strain)/General
                   ...
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Baneling/HotSRaptor', 'BurrowDown'], #HotS Campaign/Zerg/Units/Zergling (Raptor Strain)
                   ['Move', 'Stop', 'MoveHoldPosition', 'MovePatrol', 'Attack', 'Baneling/HotSSwarmling', 'BurrowDown'], #HotS Campaign/Zerg/Units/Zergling (Swarmling Strain)
